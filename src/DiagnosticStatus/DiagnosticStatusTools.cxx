#include "DiagnosticStatusTools.h"
...
DiagnosticStatusTools::~DiagnosticStatusTools()
{
...
bool DiagnosticStatusTools::init(const std::string& file_path, const std::string &profile_name, const std::string &sub_topic_name, const std::string &pub_topic_name)
{
    ...
    subscriber = std::make_unique<DiagnosticStatusSubscriber>(participant);
    publisher = std::make_unique<DiagnosticStatusPublisher>(participant);
...
void DiagnosticStatusTools::run()
{
