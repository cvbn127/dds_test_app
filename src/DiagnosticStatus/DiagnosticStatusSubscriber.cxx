...
/*!
 * @file DiagnosticStatusSubscriber.cpp
...
std::function<void(const diagnostic_msgs::msg::DiagnosticStatus&)> DiagnosticStatusSubscriber::callback = [](auto msg){};
static std::chrono::steady_clock::time_point last_received_timepoint = std::chrono::steady_clock::now();

DiagnosticStatusSubscriber::DiagnosticStatusSubscriber(eprosima::fastrtps::Participant *participant) : mp_participant(participant), mp_subscriber(nullptr) {
}

DiagnosticStatusSubscriber::~DiagnosticStatusSubscriber() 
{
...
void DiagnosticStatusSubscriber::set_callback(std::function<void(const diagnostic_msgs::msg::DiagnosticStatus&)> cb)
{
    callback = cb;
}

bool DiagnosticStatusSubscriber::init(const std::string &topic_name, const std::string &profile_name)
{
...
void DiagnosticStatusSubscriber::SubListener::onSubscriptionMatched(Subscriber* sub,MatchingInfo& info)
{
    (void)sub;
...
void DiagnosticStatusSubscriber::SubListener::onNewDataMessage(Subscriber* sub)
{
    // Take data
...
void DiagnosticStatusSubscriber::run()
{
