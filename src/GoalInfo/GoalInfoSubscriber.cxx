...
GoalInfoSubscriber::~GoalInfoSubscriber() 
{
...
void GoalInfoSubscriber::set_callback(std::function<void(const action_msgs::msg::GoalInfo&)> cb)
{
    callback = cb;
}

bool GoalInfoSubscriber::init()
{
    ...
    Rparam.topic.topicName = "GoalInfo_test";
    Rparam.historyMemoryPolicy = PREALLOCATED_WITH_REALLOC_MEMORY_MODE;
    // Rparam.topic.topicName = "GoalInfo_pub";
...
void GoalInfoSubscriber::SubListener::onSubscriptionMatched(Subscriber* sub,MatchingInfo& info)
{
    (void)sub;
...
void GoalInfoSubscriber::SubListener::onNewDataMessage(Subscriber* sub)
{
    // Take data
