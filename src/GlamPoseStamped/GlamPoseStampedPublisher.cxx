...
/*!
 * @file GlamPoseStampedPublisher.cpp
...
GlamPoseStampedPublisher::GlamPoseStampedPublisher(eprosima::fastrtps::Participant *participant) : mp_participant(participant), mp_publisher(nullptr) {}

GlamPoseStampedPublisher::~GlamPoseStampedPublisher() 
{	
...
bool GlamPoseStampedPublisher::init(int rate, const std::string &publisher_topic_name, const std::string &profile_name)
{
    m_rate = rate;
...
void GlamPoseStampedPublisher::PubListener::onPublicationMatched(Publisher* pub,MatchingInfo& info)
{
    (void)pub;
...
void GlamPoseStampedPublisher::publish(const glam_msgs::msg::PoseStamped &msg)
{
    std::cout << "publish" << std::endl;
    mp_publisher->write(const_cast<glam_msgs::msg::PoseStamped *>(&msg));
}

void GlamPoseStampedPublisher::update_message(const glam_msgs::msg::PoseStamped &msg)
{
    latest_message = msg;
}

void GlamPoseStampedPublisher::run()
{
