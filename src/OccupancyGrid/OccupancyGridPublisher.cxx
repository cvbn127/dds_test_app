...
/*!
 * @file OccupancyGridPublisher.cpp
...
bool OccupancyGridPublisher::init(int rate)
{
    m_rate = rate;
...
void OccupancyGridPublisher::publish(const nav_msgs::msg::OccupancyGrid &msg)
{
    std::cout << "publish" << std::endl;
    mp_publisher->write(const_cast<nav_msgs::msg::OccupancyGrid *>(&msg));
}

void OccupancyGridPublisher::PubListener::onPublicationMatched(Publisher* pub,MatchingInfo& info)
{
    (void)pub;
...
void OccupancyGridPublisher::run()
{
