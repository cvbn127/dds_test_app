...
/*!
 * @file RTPRouteTaskSubscriber.cpp
...
std::function<void(const rtp_msgs::msg::RTPRouteTask&)> RTPRouteTaskSubscriber::callback = [](auto msg){};
static std::chrono::steady_clock::time_point last_received_timepoint = std::chrono::steady_clock::now();

RTPRouteTaskSubscriber::RTPRouteTaskSubscriber(eprosima::fastrtps::Participant *participant) : mp_participant(participant), mp_subscriber(nullptr) {
}

RTPRouteTaskSubscriber::~RTPRouteTaskSubscriber() 
{
...
void RTPRouteTaskSubscriber::set_callback(std::function<void(const rtp_msgs::msg::RTPRouteTask&)> cb)
{
    callback = cb;
}

bool RTPRouteTaskSubscriber::init(const std::string &topic_name, const std::string &profile_name)
{
...
void RTPRouteTaskSubscriber::SubListener::onSubscriptionMatched(Subscriber* sub,MatchingInfo& info)
{
    (void)sub;
...
void RTPRouteTaskSubscriber::SubListener::onNewDataMessage(Subscriber* sub)
{
    // Take data
    rtp_msgs::msg::RTPRouteTask st;
...
void RTPRouteTaskSubscriber::run()
{
