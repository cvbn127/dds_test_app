...
std::function<void(const rtp_msgs::msg::RouteTask&)> RTPRouteTaskSubscriber::callback = [](auto msg){};
...
void RTPRouteTaskSubscriber::set_callback(std::function<void(const rtp_msgs::msg::RouteTask&)> cb)
{
    callback = cb;
}
