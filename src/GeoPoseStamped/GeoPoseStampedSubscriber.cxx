...
/*!
 * @file GeoPoseStampedSubscriber.cpp
...
std::function<void(const geographic_msgs::msg::GeoPoseStamped&)> GeoPoseStampedSubscriber::callback = [](auto msg){};
static std::chrono::steady_clock::time_point last_received_timepoint = std::chrono::steady_clock::now();

GeoPoseStampedSubscriber::GeoPoseStampedSubscriber(eprosima::fastrtps::Participant *participant) : mp_participant(participant), mp_subscriber(nullptr) {
}

GeoPoseStampedSubscriber::~GeoPoseStampedSubscriber() 
{
...
void GeoPoseStampedSubscriber::set_callback(std::function<void(const geographic_msgs::msg::GeoPoseStamped&)> cb)
{
    callback = cb;
}

bool GeoPoseStampedSubscriber::init(const std::string &topic_name, const std::string &profile_name)
{
...
void GeoPoseStampedSubscriber::SubListener::onSubscriptionMatched(Subscriber* sub,MatchingInfo& info)
{
    (void)sub;
...
void GeoPoseStampedSubscriber::SubListener::onNewDataMessage(Subscriber* sub)
{
    // Take data
    geographic_msgs::msg::GeoPoseStamped st;
...
void GeoPoseStampedSubscriber::run()
{
