...
/*!
 * @file GeoPoseStampedPublisher.cpp
...
GeoPoseStampedPublisher::GeoPoseStampedPublisher(eprosima::fastrtps::Participant *participant) : mp_participant(participant), mp_publisher(nullptr) {}

GeoPoseStampedPublisher::~GeoPoseStampedPublisher() 
{	
...
bool GeoPoseStampedPublisher::init(int rate, const std::string &publisher_topic_name, const std::string &profile_name)
{
    m_rate = rate;
...
void GeoPoseStampedPublisher::PubListener::onPublicationMatched(Publisher* pub,MatchingInfo& info)
{
    (void)pub;
...
void GeoPoseStampedPublisher::publish(const geographic_msgs::msg::GeoPoseStamped &msg)
{
    std::cout << "publish" << std::endl;
    mp_publisher->write(const_cast<geographic_msgs::msg::GeoPoseStamped *>(&msg));
}

void GeoPoseStampedPublisher::update_message(const geographic_msgs::msg::GeoPoseStamped &msg)
{
    latest_message = msg;
}

void GeoPoseStampedPublisher::run()
{
