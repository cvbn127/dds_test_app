...
/*!
 * @file PolygonArraySubscriber.cpp
...
std::function<void(const gis_rtk_msgs::msg::PolygonArray&)> PolygonArraySubscriber::callback = [](auto msg){};

PolygonArraySubscriber::PolygonArraySubscriber() : mp_participant(nullptr), mp_subscriber(nullptr) {
}

PolygonArraySubscriber::~PolygonArraySubscriber() {	Domain::removeParticipant(mp_participant);}

void PolygonArraySubscriber::set_callback(std::function<void(const gis_rtk_msgs::msg::PolygonArray&)> cb)
{
    callback = cb;
}

bool PolygonArraySubscriber::init()
{
    ...
    Rparam.topic.topicName = "PolygonArray_test";
    Rparam.historyMemoryPolicy = PREALLOCATED_WITH_REALLOC_MEMORY_MODE;
    // Rparam.topic.topicName = "PolygonArray_pub";
...
void PolygonArraySubscriber::SubListener::onSubscriptionMatched(Subscriber* sub,MatchingInfo& info)
{
    (void)sub;
...
void PolygonArraySubscriber::SubListener::onNewDataMessage(Subscriber* sub)
{
    // Take data
...
void PolygonArraySubscriber::run()
{
