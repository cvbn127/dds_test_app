...
/*!
 * @file MarkerArrayStampedSubscriber.cpp
...
std::function<void(const glam_msgs::msg::MarkerArrayStamped&)> MarkerArrayStampedSubscriber::callback = [](auto msg){};
static std::chrono::steady_clock::time_point last_received_timepoint = std::chrono::steady_clock::now();

MarkerArrayStampedSubscriber::MarkerArrayStampedSubscriber(eprosima::fastrtps::Participant *participant) : mp_participant(participant), mp_subscriber(nullptr) {
}

MarkerArrayStampedSubscriber::~MarkerArrayStampedSubscriber() 
{
...
void MarkerArrayStampedSubscriber::set_callback(std::function<void(const glam_msgs::msg::MarkerArrayStamped&)> cb)
{
    callback = cb;
}

bool MarkerArrayStampedSubscriber::init(const std::string &topic_name, const std::string &profile_name)
{
...
void MarkerArrayStampedSubscriber::SubListener::onSubscriptionMatched(Subscriber* sub,MatchingInfo& info)
{
    (void)sub;
...
void MarkerArrayStampedSubscriber::SubListener::onNewDataMessage(Subscriber* sub)
{
    // Take data
    glam_msgs::msg::MarkerArrayStamped st;
...
void MarkerArrayStampedSubscriber::run()
{
