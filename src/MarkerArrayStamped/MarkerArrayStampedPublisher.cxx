...
/*!
 * @file MarkerArrayStampedPublisher.cpp
...
MarkerArrayStampedPublisher::MarkerArrayStampedPublisher(eprosima::fastrtps::Participant *participant) : mp_participant(participant), mp_publisher(nullptr) {}

MarkerArrayStampedPublisher::~MarkerArrayStampedPublisher() 
{	
...
bool MarkerArrayStampedPublisher::init(int rate, const std::string &publisher_topic_name, const std::string &profile_name)
{
    m_rate = rate;
    ...
    std::cout << "Publisher created, waiting for Subscribers. " << publisher_topic_name << std::endl;
    return true;
}

void MarkerArrayStampedPublisher::PubListener::onPublicationMatched(Publisher* pub,MatchingInfo& info)
{
    (void)pub;
...
void MarkerArrayStampedPublisher::publish(const glam_msgs::msg::MarkerArrayStamped &msg)
{
    std::cout << "publish" << std::endl;
    mp_publisher->write(const_cast<glam_msgs::msg::MarkerArrayStamped *>(&msg));
}

void MarkerArrayStampedPublisher::update_message(const glam_msgs::msg::MarkerArrayStamped &msg)
{
    latest_message = msg;
}

void MarkerArrayStampedPublisher::run()
{
    ...
    std::vector<glam_msgs::msg::Marker> data(2);
    latest_message.markers(data);
    // std::vector<glam_msgs::msg::Point32> polygon_points(3);
    // glam_msgs::msg::Point32 point{};
    // point.x() = 42;
    // point.y() = 11;
    // point.z() = -4.2;
