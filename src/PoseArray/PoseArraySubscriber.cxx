...
std::function<void(const geometry_msgs::msg::PoseArray&)> PoseArraySubscriber::callback = [](auto msg){};
static std::chrono::steady_clock::time_point last_received_timepoint = std::chrono::steady_clock::now();

PoseArraySubscriber::PoseArraySubscriber(eprosima::fastrtps::Participant *participant) : mp_participant(participant), mp_subscriber(nullptr) {
}

PoseArraySubscriber::~PoseArraySubscriber() 
{
...
void PoseArraySubscriber::set_callback(std::function<void(const geometry_msgs::msg::PoseArray&)> cb)
{
    callback = cb;
}

bool PoseArraySubscriber::init(const std::string &topic_name, const std::string &profile_name)
{
...
void PoseArraySubscriber::SubListener::onSubscriptionMatched(Subscriber* sub,MatchingInfo& info)
{
    (void)sub;
...
void PoseArraySubscriber::SubListener::onNewDataMessage(Subscriber* sub)
{
    // Take data
    geometry_msgs::msg::PoseArray st;
