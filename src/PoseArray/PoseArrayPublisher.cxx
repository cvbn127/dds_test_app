...
PoseArrayPublisher::PoseArrayPublisher(eprosima::fastrtps::Participant *participant) : mp_participant(participant), mp_publisher(nullptr) {}

PoseArrayPublisher::~PoseArrayPublisher() 
{	
...
bool PoseArrayPublisher::init(int rate, const std::string &publisher_topic_name, const std::string &profile_name)
{
    m_rate = rate;
...
void PoseArrayPublisher::PubListener::onPublicationMatched(Publisher* pub,MatchingInfo& info)
{
    (void)pub;
...
void PoseArrayPublisher::publish(const geometry_msgs::msg::PoseArray &msg)
{
    std::cout << "publish" << std::endl;
    mp_publisher->write(const_cast<geometry_msgs::msg::PoseArray *>(&msg));
}

void PoseArrayPublisher::update_message(const geometry_msgs::msg::PoseArray &msg)
{
    latest_message = msg;
}

void PoseArrayPublisher::run()
{
    ...
    // std::vector<geometry_msgs::msg::Region> data(2);
