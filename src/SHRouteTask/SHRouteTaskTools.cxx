...
SHRouteTaskTools::~SHRouteTaskTools()
{
...
bool SHRouteTaskTools::init(const std::string& file_path, const std::string &profile_name, const std::string &sub_topic_name, const std::string &pub_topic_name)
{
    ...
    subscriber = std::make_unique<SHRouteTaskSubscriber>(participant);
    publisher = std::make_unique<SHRouteTaskPublisher>(participant);
