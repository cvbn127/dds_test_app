...
/*!
 * @file SHRouteTaskSubscriber.cpp
...
std::function<void(const sh_chassis_msgs::msg::RouteTask&)> SHRouteTaskSubscriber::callback = [](auto msg){};
static std::chrono::steady_clock::time_point last_received_timepoint = std::chrono::steady_clock::now();

SHRouteTaskSubscriber::SHRouteTaskSubscriber(eprosima::fastrtps::Participant *participant) : mp_participant(participant), mp_subscriber(nullptr) {
}

SHRouteTaskSubscriber::~SHRouteTaskSubscriber() 
{
...
void SHRouteTaskSubscriber::set_callback(std::function<void(const sh_chassis_msgs::msg::RouteTask&)> cb)
{
    callback = cb;
}

bool SHRouteTaskSubscriber::init(const std::string &topic_name, const std::string &profile_name)
{
...
void SHRouteTaskSubscriber::SubListener::onSubscriptionMatched(Subscriber* sub,MatchingInfo& info)
{
    (void)sub;
...
void SHRouteTaskSubscriber::SubListener::onNewDataMessage(Subscriber* sub)
{
    // Take data
    sh_chassis_msgs::msg::RouteTask st;
...
void SHRouteTaskSubscriber::run()
{
