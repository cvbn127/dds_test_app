...
ObjectsArrayTools::~ObjectsArrayTools()
{
...
bool ObjectsArrayTools::init(const std::string& file_path, const std::string &profile_name, const std::string &sub_topic_name, const std::string &pub_topic_name)
{
    ...
    subscriber = std::make_unique<ObjectsArraySubscriber>(participant);
    publisher = std::make_unique<ObjectsArrayPublisher>(participant);
