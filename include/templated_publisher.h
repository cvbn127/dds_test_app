...
namespace dds_test_app
{
    ...
    template <typename PubSubType>
    class TemplatedPublisher
    {
    public:
        using message_type = typename PubSubType::type;
        TemplatedPublisher(eprosima::fastrtps::Participant *participant = nullptr) :
        ...
        bool init(int rate, const std::string &topic_name, const std::string &profile_name = "test-app-profile")
        {
            m_rate = rate;
            ...
            if ( eprosima::fastrtps::xmlparser::XMLP_ret::XML_ERROR == eprosima::fastrtps::xmlparser::XMLProfileManager::fillPublisherAttributes(profile_name, publisher_att))
            {
            ...
            mp_publisher = eprosima::fastrtps::Domain::createPublisher(mp_participant, publisher_att ,static_cast<PubListener*>(&m_listener));
        ...
        void update_message(const message_type &msg)
        {
            latest_message = msg;
        };
